...
public class CandidateMainActivity extends Activity {
    ...
    public void onClick(View v) {
    	    ...
    	    case R.id.bSendAnswerActivity2:
    	    	Intent intent = new Intent(CandidateMainActivity.this,EmployerMainActivity.class);
		...
		if (resultCode == RESULT_OK) {
			...
			case REQUESTCODE_RESPONSE:
				responseIntent = dataIntent.getExtras();
					if (responseIntent.get(EmployerMainActivity.RESPONSE_TEXT_KEY) != null) {
						...
						.setMessage(responseIntent.get(EmployerMainActivity.RESPONSE_TEXT_KEY).toString()).setIcon(R.drawable.ic_launcher);
